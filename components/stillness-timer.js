// ==============================
// <stillness-timer> — Countdown Engine
...
export class StillnessTimer extends LitElement {
  static properties = {
    running:   { type: Boolean },
    duration:  { type: Number }, // total seconds
    remaining: { type: Number }, // seconds left (read externally)
  };
...
customElements.define('stillness-timer', StillnessTimer);
